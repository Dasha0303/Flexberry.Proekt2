...
namespace IIS.Proekt2
{
    ...
    public class Оценка : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proekt2.Стaтусы fСтатус;
        ...
        public virtual IIS.Proekt2.Стaтусы Статус
        {
            get
            {
                ...
                IIS.Proekt2.Стaтусы result = this.fСтатус;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОценкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОценкаE", typeof(IIS.Proekt2.Оценка));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОценкаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОценкаL", typeof(IIS.Proekt2.Оценка));
                }
            }
        }
    }
